...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GoalRecord.participant'
        db.add_column('experiments_goalrecord', 'participant',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['experiments.Participant'], null=True, blank=True),
                      keep_default=False)


        # Changing field 'GoalRecord.anonymous_visitor'
        db.alter_column('experiments_goalrecord', 'anonymous_visitor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['experiments.AnonymousVisitor'], null=True))

    def backwards(self, orm):
        # Deleting field 'GoalRecord.participant'
        db.delete_column('experiments_goalrecord', 'participant_id')


        # User chose to not deal with backwards NULL issues for 'GoalRecord.anonymous_visitor'
        raise RuntimeError("Cannot reverse this migration. 'GoalRecord.anonymous_visitor' and its values cannot be restored.")
    ...
    models = {
        ...
        'experiments.dailyengagementreport': {
            ...
            'confidence': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'control_group_size': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
        ...
        'experiments.goalrecord': {
            ...
            'goal_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['experiments.GoalType']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'participant': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['experiments.Participant']", 'null': 'True', 'blank': 'True'})
        },
